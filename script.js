...
function criarQuizz() {
    ...
    tela3_1.classList.remove("desaparece")
...
// FUNCAO PARA EMBARALHAR RESPOSTAS DO QUIZZ
function comparador() { 
...
const tela3_1 = document.querySelector(".tela3_1")
...
function buttonPerguntas(){
    ...
    numeroQuestoes = document.querySelector('#input_3').value
    numeroNiveis = document.querySelector('#input_4').value

    let nivesQuestoes = (numeroNiveis >= 2 && numeroQuestoes >=3);
...
function questoesTela_2(i){
    let perguntas = document.querySelector(`.perguntas${i}`)
    perguntas.classList.toggle('desaparece')
}
...
function checkQuestoes(){
    ...
    if(checkTudo && objeto.questions.length == numeroQuestoes && validar){
        // adicionar 
